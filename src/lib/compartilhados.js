...
export const estilosComuns = {
  ...
  link: { color: '#42a5f5', textDecoration: 'none', fontWeight: 500 },
  lista: {
    listStyle: 'none',
    padding: 0,
    margin: 0,
  ...
  saldo: { fontWeight: 600, color: '#42A5F5', fontVariantNumeric: 'tabular-nums' },
  valorEntrada: { fontWeight: 600, color: '#4ade80', fontVariantNumeric: 'tabular-nums' },
  valorSaida: { fontWeight: 600, color: '#f87171', fontVariantNumeric: 'tabular-nums' },
}