...
- [diario/2026-09-22.md](diario/2026-09-22.md) — Modo Calendário no Planejamento (toggle Lista/Calendário, mês próprio via `listarPorPeriodo`, seletor de período oculto no modo calendário, semana seg–dom, grid rígido `minmax(0,1fr)` com ellipsis, tela cheia `100vw` furando o `CaberNaTela` de 720px; não commitado)
